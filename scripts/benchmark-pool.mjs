...
const DATA = resolve(__dirname, "../sportverse/packages/sports-db/data");

const { __setExtendedDataForTests } = await import("@sportverse/sports-db");
const { setAwardsData } = await import("@sportverse/rating-engine");
const { buildDraftPool, PRESET_MODES } = await import("@sportverse/draftballer-core");
